...
export default function Calendar() {
  ...
  const handleDayToggle = (selectedDay: number) => {
    const updatedDays = newEvent.daysOfWeek?.includes(selectedDay.toString())
      ? (newEvent.daysOfWeek || "")
          .split(",")
          .filter((day) => day !== selectedDay.toString())
          .join(",")
                      ...
                      <form onSubmit={handleSubmit}>
                        <div>
                          ...
                          <div className="mt-5">
                            ...
                            <p className="m-2 font-extralight">
                              Déjelo en blanco si no tiene un día en el que
                              desee repetir el evento cada semana.
                            </p>
                            <div>
