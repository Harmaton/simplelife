...
import breath from '@/lib/lotties/breath-lottie.json'
...
export default function Page() {
  ...
  return (
    <div className='m-auto'>
        ...
        <PageHeaderHeading size='sm'>Ejercicio de respiración consciente</PageHeaderHeading>
      </PageHeader>
      ...
      >
        {isBreathing ? (
          ...
          <>
            ...
            Comience el ejercicio de respiración
          </>
        )}
      </Button>
        ...
        <CardContent>
            ...
            <div className='lg:text-center lg:justify-center border'>
              <h1 className='text-center animate-pulse'>{formatTime(totalBreathingTime)}</h1>
            </div>
            <div className='lg:text-center border'>
              <h1 className='text-center animate-pulse'>{breathText}</h1>
            </div>
          </div>
          <Lottie
